...
use crate::type_registry::RegisterType;
...
impl AppPlugin for RenderPlugin {
    fn build(&self, app: &mut AppBuilder) {
        app.add_stage_after(crate::asset::stage::ASSET_EVENTS, stage::RENDER_RESOURCE)
            ...
            .add_system_to_stage(crate::app::stage::PRE_UPDATE, clear_draw_system.system())
            .add_system_to_stage(
                crate::app::stage::POST_UPDATE,
