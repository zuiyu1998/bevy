...
use crate::{Archetype, Component, Query, entities::EntityMeta};
...
impl<'a, Q: Query> QueryOne<'a, Q> {
    ...
    pub(crate) unsafe fn new(archetype: &'a Archetype, meta: &'a [EntityMeta], index: u32) -> Self {
        Self { 
            archetype,
            meta,
            index,
